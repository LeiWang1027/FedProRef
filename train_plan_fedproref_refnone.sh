...
# Training plan: FedProRef refiner=none ablation
...
#
# Usage:
#   bash train_plan_fedproref_refnone.sh
#   DRY_RUN=1 bash train_plan_fedproref_refnone.sh
#   MAX_JOBS=3 bash train_plan_fedproref_refnone.sh
